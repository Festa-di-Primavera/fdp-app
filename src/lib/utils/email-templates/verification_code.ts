    ...
    return `
		...
		<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; color: #333;">
			<div style="background-color: #ffffff; margin: 50px auto; padding: 20px; max-width: 600px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
				<div style="text-align: center; background-color: ${COLORS.headerBg}; padding: 20px 0; border-radius: 10px 10px 0 0;">
					<img src="cid:logo" alt="email-logo" border="0" height="75rem">
				</div>
				<div style="padding: 30px; text-align: center;">
					...
					<div style="text-align: center; margin: 20px 0;">
						<div style="font-size: 28px; font-weight: bold; color: ${COLORS.primary}; background-color: #f9f9f9; padding: 15px; border: 2px dashed ${COLORS.primary}; letter-spacing: 5px; display: inline-block; margin-bottom: 10px;">${code}</div>
					</div>
